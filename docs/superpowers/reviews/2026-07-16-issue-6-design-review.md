...
| Developer/API | Separate concrete services fit the workshop goal; immutable models, exact exports, typed upstream errors, files, and tests are implementable. | 0 | 0 | None open. |
